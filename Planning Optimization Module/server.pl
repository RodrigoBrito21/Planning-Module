% Declaração de fatos dinâmicos para permitir modificação em tempo de execução
...
% Agenda de horários ocupados por membros da equipe (exemplo de 28/10/2024)
agenda_staff(d001,20241028,[(720,790,m01),(1080,1140,c01)]).
agenda_staff(d002,20241028,[(850,900,m02),(901,960,m02),(1380,1440,c02)]).
agenda_staff(d003,20241028,[(720,790,m01),(910,980,m02)]).

% Horários de trabalho (timetables) de membros da equipe no dia especificado
...
% Declaração de tipos de cirurgia (tipo, tempo de anestesia, tempo da cirurgia, tempo de limpeza)
surgery(so2,45,60,45).
surgery(so3,45,90,45).
surgery(so4,45,75,45).

% Associações entre IDs de cirurgias e seus tipos
...
% Associação de cirurgias a médicos
...
% Agenda da sala de operação inicial
agenda_operation_room(or1,20241028,[(520,579,so100000),(1000,1059,so099999)]).

% Conversão de agendas ocupadas para agendas livres
% free_agenda0/2 inicializa a lista de intervalos livres baseada na lista ocupada
free_agenda0([],[(0,1440)]).
...
% Adapta uma agenda livre considerando o início e fim do expediente (timetable)
...
% Interseção de todas as agendas para encontrar intervalos comuns
...
% Agendamento de todas as cirurgias
schedule_all_surgeries(Room,Day):-
    retractall(agenda_staff1(_,_,_)),
    retractall(agenda_operation_room1(_,_,_)),
    retractall(availability(_,_,_)),
    % Configura agendas iniciais
    ...
    % Tenta agendar todas as cirurgias
...
% Avalia todas as combinações possíveis de sequências de cirurgias
